...
database = pulumi_aws.rds.Instance(
    ...
    final_snapshot_identifier="tsa-db1-final",
    skip_final_snapshot=True,
    vpc_security_group_ids=[databaseSecurityGroup.id]
)

pulumi.export('tsa-db', database.endpoint)
